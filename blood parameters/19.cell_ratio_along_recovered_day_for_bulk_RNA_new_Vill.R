...
True_sc_Vill_cell_ratio <- read.table(file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/True_sc_Vill_cell_ratio.txt",header = T,sep = "\t")
#
flag_tag<-"manu_sig_no_1K"
CIBERSORTx_pesudo_Vill <- read.table(file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/seurat_result/CIBERSORTx_pesudo_Mixture_Vill.txt",header = T,sep = "\t")
...
write.table(as.data.frame(com_data),file=paste0("D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/seurat_result/file1_True_SC_Cell_ratio_CsX_Ratio_value_",flag_tag,".txt"),sep = "\t",row.names=F) 
write.table(as.data.frame(correlation_results),file=paste0("D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/seurat_result/file2_True_SC_Cell_ratio_CsX_correlationship_data_",flag_tag,".txt"),sep = "\t",row.names=F) 
...
index_plot
ggsave(index_plot,file=paste0("D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/seurat_result/file3_True_SC_Cell_ratio_CsX_correlationship_",flag_tag,".pdf"),width = 12, height =10)
...
index_plot
ggsave(index_plot,file=paste0("D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/seurat_result/file4_True_SC_Cell_ratio_CsX_correlationship_no_split_",flag_tag,".pdf"),width = 12, height =10)


##########################################################
##for Vill sample
Vill_cell_ratio <- read.table(file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_manu.txt",header = T,sep = "\t")
...
Ratio_0
ggsave(Ratio_0,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_barplot.pdf",width = 16, height =8)
...
##感染与未感染的组间比较
#因子在感染与非感染组的组间比较
analysis_collect0<-analysis_Vill[,c("sample_code","Age","LMP_infect","LMP_operate","infect_state","gender","group_day2",colnames(Vill_cell_ratio2[,-c(1,ncol(Vill_cell_ratio2))]))]
...
ggsave(stat_boxplot,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_compare_stat_box_infect_state.pdf",width = 16, height =12)
...
stat_data[which(stat_data$p.signif != "ns"),]
# A tibble:  28 x 9
write.table(as.data.frame(stat_data), file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/intergroup_compare_pvalue_wilcox_test_each_cell_Vill_data.txt",sep = "\t",row.names=F) 
...
ggsave(Daygroup_stat_boxplot1,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_box_static_compare_group_day_CTRL_compare.pdf",width = 25, height =22)
ggsave(Daygroup_stat_boxplot2,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_box_static_compare_group_day_D7_compare.pdf",width = 25, height =22)
ggsave(Daygroup_stat_boxplot10,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_box_static_compare_group_day_CTRL_compare2.pdf",width = 25, height =22)
ggsave(Daygroup_stat_boxplot20,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_box_static_compare_group_day_D7_compare2.pdf",width = 25, height =22)
...
write.table(as.data.frame(correlation_results), file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/Spearman_pvalue_each_cell_Vill_data.txt",sep = "\t",row.names=F) 
correlation_results[which(correlation_results$p_value<0.05),]
#  Cell  correlation p_value
#1 STBs        0.217 0.0240 
#2 EVTs       -0.217 0.0241 
#3 STCs       -0.273 0.00429
#4 HCs        -0.307 0.00121
...
ggsave(index_plot10,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_sm_trend_plot.pdf",width = 16, height =12)
ggsave(index_plot30,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_lm_single_plot.pdf",width = 16, height =12)
ggsave(index_plot31,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_lm_age_split_plot.pdf",width = 16, height =12)
ggsave(index_plot32,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_lm_no_age_split_plot.pdf",width = 16, height =12)
ggsave(index_plot33,file="D:/PROJECT/新冠/manuscript/2.Figure/转录组结果/bulk_RNA_result/4.cellratio_result1203_vill/bulk_result/CIBERSORTx_Vill_bulk_cell_ratio_sm_no_age_split_plot.pdf",width = 16, height =12)
